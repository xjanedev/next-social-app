...
function useMe() {
    ...
    var setBookmark = function (postId, bookmark) {
        if (!user)
            return;
        var bookmarks = user === null || user === void 0 ? void 0 : user.bookmarks;
    ...
    return { user: user, isLoading: isLoading, error: error, setBookmark: setBookmark };
}
