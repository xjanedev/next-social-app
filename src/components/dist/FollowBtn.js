...
function FollowButton(_a) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null, showButton && (react_1["default"].createElement(ToggleButton_1["default"], { text: text, onClick: function () { }, red: text === "Unfollow" }))));
}
