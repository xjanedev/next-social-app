...
var menu = [
    {
        href: "/",
        icon: React.createElement(icons_1.HomeIcon, null),
        clickedIcon: React.createElement(icons_1.HomeFillIcon, null)
    },
    {
        href: "/search",
...
function Navbar() {
    var session = react_1.useSession().data; // next-auth hook
