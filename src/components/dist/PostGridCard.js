...
function PostGridCard(_a) {
    ...
    var sesesion = react_2.useSession().data; // usesession hook 사용한다.
    var handleOpenPost = function () {
        if (!(sesesion === null || sesesion === void 0 ? void 0 : sesesion.user)) {
            return react_2.signIn();
        }
        setOpenModal(true);
    };
    return (React.createElement("div", { className: 'relative w-full aspect-square' },
        React.createElement(image_1["default"], { className: 'object-cover', src: image, alt: "photo by " + username, fill: true, sizes: '650px', priority: priority, onClick: handleOpenPost }),
