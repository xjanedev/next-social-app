...
function NewPost(_a) {
    ...
    return (React.createElement("section", { className: 'm-auto w-full max-w-xl flex flex-col items-center mt-6' },
        ...
        React.createElement("form", { className: 'w-full flex flex-col mt-2' },
            React.createElement("input", { className: 'hidden', name: 'input', id: 'input-upload', type: 'file', accept: 'image/*', onChange: handleChange }),
            React.createElement("label", { className: "w-full h-96 flex flex-col items-center justify-center rounded-3xl " + (!file && "border border-gray-200"), htmlFor: 'input-upload', onDragEnter: handleDrag, onDragLeave: handleDrag, onDragOver: handleDragOver, onDrop: handleDrop },
                ...
                !file && (React.createElement("div", { className: 'flex flex-col items-center pointer-events-none' },
                    React.createElement("p", { className: 'text-sm text-gray-300' }, "Drag and Drop your image here or click"))),
            ...
            React.createElement("textarea", { className: 'outline-none mt-2 text-sm p-6 border border-gray-200 resize-none rounded-3xl', name: 'text', id: 'input-text', required: true, rows: 8, placeholder: "What's on your mind?" }),
