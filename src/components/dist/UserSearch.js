...
function UserSearch() {
    ...
    return (React.createElement("section", { className: 'w-[580px] flex flex-col pt-9 m-auto' },
        React.createElement("form", { className: 'w-full mb-4', onSubmit: onSubmit },
            React.createElement("input", { className: 'w-full rounded-xl text-sm p-3 outline-none border border-gray-800', type: 'text', autoFocus: true, placeholder: 'search for a username or name', value: keyword, onChange: function (e) { return setKeyword(e.target.value); } })),
