...
function PUT(req) {
    return __awaiter(this, void 0, void 0, function () {
        var session, user, _a, targetId, isFollow, request;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a = _b.sent(), targetId = _a.id, isFollow = _a.follow;
                    if (!targetId || isFollow === undefined) {
                        return [2 /*return*/, new Response("Bad Request", { status: 400 })];
                    }
                    request = isFollow ? user_1.follow : user_1.unfollow;
                    return [2 /*return*/, request(user.id, targetId)
